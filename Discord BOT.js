...
const SessionBase = new Airtable({apiKey: 'TOKEN'}).base('appZVNPER2qH6vdnJ');
const SkillBase = new Airtable({apiKey: 'TOKEN'}).base('app5rtOzZ8X6ee5hU');
...
client.login('NzI2NzkzMDY4OTA4NjQyMzE0.Xvicyg.klOhNCVLHsGve_rpujlcvBy82Z4');